...
`sihtric-penny.pack.draft.json` now applies the complete Mayo authoring pattern
without promoting provisional numismatics into the app:
...
not specialist clearance. The shipping app keeps the five-page editorial preview
until the numismatist, historian, pedagogy, native-speaker audio and rights gates
below close.
